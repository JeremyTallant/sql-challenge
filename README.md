...
![Vector_2640](https://user-images.githubusercontent.com/112406455/203343280-7cb0ce36-e698-4dec-aadc-3368d26f6b77.jpg)
...
<img width="1133" alt="Screenshot 2022-11-22 at 7 52 53 AM" src="https://user-images.githubusercontent.com/112406455/203332318-8a069e49-0121-4db7-8fb0-e57f4f244adf.png">

2. Create a histogram to visualize the employee salary ranges that were the most common.

![histogram](https://user-images.githubusercontent.com/112406455/203332411-874fe1e2-7d74-41d6-a407-101cd6daa2fe.png)

3. Create a bar chart of average salary by title.

![barchart](https://user-images.githubusercontent.com/112406455/203332456-de125398-f873-4365-85cf-db73786040a3.png)

### Code execution instructions:
* Download the repository onto you computer
* Inspect the CSV files, and then sketch an ERD of the tables. Quick DBD was used to sketch an ERD of the tables. Link:"https://www.quickdatabasediagrams.com/" An image of the ERD is located in the "Images" folder.
* Open pgAdmin 4 on your desktop
* Right click on "Databases", then select "Create", then click "Database...", and name the database: "employee_db"
* Once the database is created, right click on the database and select "Query Tool"
* Then open the "table_schemata.sql" file in the "EmployeeSQL" folder and run the code to create all tables
* Load the csv files located in the "data" folder into the corresponding tables by right clicking on each table in the "Schemas->Tables" tab and selecting "Import/Export data". To avoid errors, import the data in the same order as the corresponding tables got created. And, remember to account for the headers when doing the imports.
* After the data is imported into the tables, open another "Query Tool" and then open the "queries.sql" file and run the code to get all queries for the Data Analysis.
* Open the "bonus_analysis.ipynb" in Jupyter Notebook and add username and password for pgAdmin 4 in the "config.py" file
